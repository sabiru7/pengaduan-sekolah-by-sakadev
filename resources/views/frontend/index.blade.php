...
@section('title', 'Pengaduan Sekolah | SMK TARUNA BHAKTI')
...
@section('content')
        ...
        <div class="order-1 w-full px-3 lg:w-1/2 lg:order-0">
          <div class="w-full lg:max-w-md">
            <h2
              ...
              Selamat Datang di Sistem Layanan Pengaduan & Aspirasi SMK TARUNA BHAKTI</h2>
  ...
  <section class="relative py-20 bg-white min-w-screen animation-fade animation-delay" id="about">
    <div class="container px-0 px-8 mx-auto sm:px-12 xl:px-5">
      ...
      <h4
        ...
        Sekilas Mengenai Aplikasi Pengaduan SMK TARUNA BHAKTI</h4>
      ...
      <div
        ...
        <p class="mt-2 text-base text-gray-600 sm:text-lg md:text-normal">ini dibuat untuk menampung pengaduan & aspirasi dari semua warga SMK TARUNA BHAKTI. Diharapkan dengan sistem ini semua warga sekolah dapat lebih mudah untuk melaporkan pengaduan & aspirasi untuk sekolah.
        </p>
      </div>
    </div>
  </section>
  ...
  <section class="relative py-16 bg-gray-100 min-w-screen animation-fade animation-delay" id="faq">
    <div class="container px-0 px-8 mx-auto sm:px-12 xl:px-5">
      ...
      <div
        class="w-full px-6 py-6 mx-auto mt-10 bg-white border border-gray-200 rounded-lg sm:px-8 md:px-12 sm:py-8 sm:shadow lg:w-5/6 xl:w-2/3">
        <h3 class="text-lg font-bold text-purple-500 sm:text-xl md:text-2xl">Apakah Aplikasi Pengaduan SMK 
          Taruna BHAKTI ini ?</h3>
        <p class="mt-2 text-base text-gray-600 sm:text-lg md:text-normal">Seperti yang sudah dijelaskan diatas tadi, aplikasi ini dibuat untuk menampung pengaduan & aspirasi dari semua warga SMK TARUNA BHAKTI.</p>
      </div>
      <div
        class="w-full px-6 py-6 mx-auto mt-10 bg-white border border-gray-200 rounded-lg sm:px-8 md:px-12 sm:py-8 sm:shadow lg:w-5/6 xl:w-2/3">
      ...
      <div
        ...
        <p class="mt-2 text-base text-gray-600 sm:text-lg md:text-normal">Kamu bisa kirim pertanyaan ke email kami : rpl.smktarunabhakti@gmail.com</p>
      </div>
    </div>
  </section>
  <!-- end FAQ --> 
